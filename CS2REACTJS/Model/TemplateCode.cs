using CS2REACTJS.Model.Serializable;
using System;
...
namespace CS2REACTJS.Model
{
    public class TemplateCode
    {
        ...
        string GetInterfaceEDlgName(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if (model == null)
            {
                return "IEdlg";
        ...
        string GetInterfaceName(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if (model == null)
            {
                return "I";
        ...
        string GetInterfaceNameEx(CS2REACTJS.Model.Serializable.DbContextSerializable context, string viewName)
        {
        ...
        string GetInterfacePageName(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if (model == null)
            {
                return "IPage";
        ...
        string GetInterfacePageNameEx(CS2REACTJS.Model.Serializable.DbContextSerializable context, string viewName)
        {
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
                return "I";
        ...
        string GetInterfaceFilterName(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            return "I" + model.ViewName + "Filter";
        }
        string GetInterfaceFilterNameEx(CS2REACTJS.Model.Serializable.DbContextSerializable context, string viewName)
        {
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
                return "I";
        ...
        string GetModelClassName(CS2REACTJS.Model.Serializable.DbContextSerializable context, string fileType)
        {
            string result = "";
        ...
        string GetPropertyTypeScriptTypeName(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop)
        {
            string result = "";
        ...
        string GetJavaScriptToStringMethod(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop)
        {
            string result = "";
            switch (prop.UnderlyingTypeName.ToLower())
            {
        ...
        string GetCCharpDatatype(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if ((prop == null) || (model == null)) return "";
            return prop.UnderlyingTypeName.ToLower().Replace("system.", "");
        }
        string GetCCharpDatatypeEx(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if ((prop == null) || (model == null)) return "";
        ...
        string GetCCharpDatatypeEx2(CS2REACTJS.Model.Serializable.ModelViewUIListPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if ((prop == null) || (model == null)) return "";
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            return GetCCharpDatatype(sclrProp, model);
        }
        string GetPropertyTypeName(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop)
        {
        ...
        string GetFolderName(CS2REACTJS.Model.Serializable.ModelViewSerializable model, string refFolder, string currFolder)
        {
            string result = "./";
        ...
        String GetWebApiServicePrefix(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool IsPrimaryKeyProperty(CS2REACTJS.Model.Serializable.ModelViewPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
        ...
        string GetTypeScriptPropertyName(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            if ((model == null) || (prop == null))
            {
                return "Noname";
        ...
        string GetFilterPropertyOperatorName(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string operatorSufix)
        {
            if (model.GenerateJSonAttribute)
            {
        ...
        string GetTypeScriptPropertyNameEx(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
        ...
        List<string> GetValidators(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, Dictionary<string, string> regExps)
        {
        ...
        bool HasCombo(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasButton(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasTypeahead(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
        ...
        bool HasInitMethod(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            return HasCombo(prop, model) || HasButton(prop, model) || HasTypeahead(prop, model);
        }
        bool HasInitMethodForInputMode(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, int inputType)
        {
            switch (inputType)
            {
                case 1:
        ...
        bool HasModelInitMethodForInputMode(CS2REACTJS.Model.Serializable.ModelViewSerializable model, int inputType)
        {
            if (model == null)
            {
                return false;
        ...
        string GetExpressionForControlList(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyNameWithSufix(prop, model, sufix) + "Vals";
        }

        string GetExpressionForOnFilterTypeaheadControlListMethod(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string typeaheadSufix)
        {
            return "OnFilter" + GetExpressionForControlList(prop, model, typeaheadSufix);
        }
        string GetExpressionForOnUpdateComboControlListMethod(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string comboSufix)
        {
            return "OnUpdate" + GetExpressionForControlList(prop, model, comboSufix);
        }
        string GetExpressionForOnValChangedMethod(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            return "OnValChanged" + GetTypeScriptPropertyNameEx(prop, model);
        }
        string GetTypeScriptPropertyNameWithSufixBase(CS2REACTJS.Model.Serializable.ModelViewPropertyOfVwSerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyName(prop, model) + sufix;
        }
        string GetTypeScriptPropertyNameWithSufix(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string sufix)
        {
            return GetTypeScriptPropertyNameEx(prop, model) + sufix;
        }
        string GetExpressionForOnInitMethod(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            return "OnInit" + GetTypeScriptPropertyNameEx(prop, model);
        }


        List<string> CollectComboListInterfaces(CS2REACTJS.Model.Serializable.DbContextSerializable context,
                                                CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        List<string> CollectButtonItemInterfaces(CS2REACTJS.Model.Serializable.DbContextSerializable context,
                                                CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        List<string> CollectTypeaheadListInterfaces(CS2REACTJS.Model.Serializable.DbContextSerializable context,
                                                CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                                CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            List<string> result = new List<string>();
        ...
        string GetFormControlHiddenCondition(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string eformModePropName)
        {
        ...
        string GetDisplayAttributeValueString(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, string propName)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            if (sclrProp == null)
            {
        ...
        bool IsDateInput(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            ModelViewPropertyOfVwSerializable sclrProp = model.ScalarProperties.Where(p => p.ViewPropertyName == prop.ViewPropertyName).FirstOrDefault();
            if (sclrProp == null)
            {
        ...
        string GetCommonEnumClassName(CS2REACTJS.Model.Serializable.DbContextSerializable context, string fileType)
        {
            string result = "";
            if ((context == null) || string.IsNullOrEmpty(fileType))
            {
        ...
        string GetCommonServiceClassName(CS2REACTJS.Model.Serializable.DbContextSerializable context, string fileType)
        {
            string result = "";
            if ((context == null) || string.IsNullOrEmpty(fileType))
            {
        ...
        string GetCommonFolderName(CS2REACTJS.Model.Serializable.ModelViewSerializable model, CS2REACTJS.Model.Serializable.DbContextSerializable context, string refFolder, string currFolder)
        {
            string result = "./";
        ...
        string GetCrossComponentFolderName(CS2REACTJS.Model.Serializable.ModelViewSerializable model, string currFolder, CS2REACTJS.Model.Serializable.DbContextSerializable context, string refViewName, string refFolder)
        {
            string result = "./";
        ...
        string GetComponentSelectorCommonPart(CS2REACTJS.Model.Serializable.ModelViewSerializable model, string fileType)
        {
            string result = "";
        ...
        string GetComponentClassName(CS2REACTJS.Model.Serializable.ModelViewSerializable model, string fileType)
        {
            string result = "";
            if ((model == null) || string.IsNullOrEmpty(fileType))
            {
        ...
        string GetComponentClassNameEx(CS2REACTJS.Model.Serializable.DbContextSerializable context, string viewName, string fileType)
        {
            string result = "";
        ...
        string GetServiceClassName(CS2REACTJS.Model.Serializable.ModelViewSerializable model, string fileType)
        {
            string result = "";
            if ((model == null) || string.IsNullOrEmpty(fileType))
            {
        ...
        string GetServiceClassNameEx(CS2REACTJS.Model.Serializable.DbContextSerializable context, string ViewName, string fileType)
        {
        ...
        string GetViewByForeignNameChain(CS2REACTJS.Model.Serializable.DbContextSerializable context, string ViewName, string foreignKeyNameChain)
        {
            if ((context == null) || (string.IsNullOrEmpty(ViewName)))
            {
                return "";
        ...
        string GetPrimKeyFilterForFindIndexMethod(CS2REACTJS.Model.Serializable.DbContextSerializable context, string ViewName, string srcPrefix, string destPrefix)
        {
            if ((context == null) || (string.IsNullOrEmpty(ViewName)))
            {
                return "false";
        ...
        string GetControlListPropertyName(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
        ...
        CS2REACTJS.Model.Serializable.ModelViewSerializable
            GetViewForControlList(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
        ...
        string GetViewNameForControlList(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop, CS2REACTJS.Model.Serializable.ModelViewSerializable model, CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
            CS2REACTJS.Model.Serializable.ModelViewSerializable mv =
        ...
        List<ModelViewPropertyOfVwSerializable> GetPrimaryKeyProps(CS2REACTJS.Model.Serializable.DbContextSerializable context, string viewName)
        {
            List<ModelViewPropertyOfVwSerializable> result = new List<ModelViewPropertyOfVwSerializable>();
            if ((context == null) || string.IsNullOrEmpty(viewName))
            {
        ...
        List<ModelViewPropertyOfVwSerializable> GetForeignKeyProps(CS2REACTJS.Model.Serializable.DbContextSerializable context, CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                                                ModelViewUIFormPropertySerializable masterProp, ModelViewUIFormPropertySerializable detailProp, int inputType)
        {
            ...
            CS2REACTJS.Model.Serializable.ModelViewSerializable detailModel =
        ...
        List<ModelViewPropertyOfVwSerializable> GetForeignKeyPropsBase(CS2REACTJS.Model.Serializable.DbContextSerializable context, CS2REACTJS.Model.Serializable.ModelViewSerializable model,
        ...
        List<string> GetFKViewsList(CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                                         CS2REACTJS.Model.Serializable.DbContextSerializable context,
        ...
        List<string> GetSearchDialogViewsList(CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                                             CS2REACTJS.Model.Serializable.DbContextSerializable context,
        ...
        List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDirectMasters(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                             CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>();
            if ((prop == null) || (model == null) || (context == null))
            {
                return result;
            }
        ...
        List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDependentScalarProps(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                                    CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                                    CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>();
            ...
            List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable> masters = GetDirectMasters(prop, model, context, inputType);
        ...
        List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>
            GetDirectDetails(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                             CS2REACTJS.Model.Serializable.DbContextSerializable context, int inputType)
        {
            List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable> result = new List<CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable>();
        ...
        bool MustHaveDirectDetails(CS2REACTJS.Model.Serializable.ModelViewUIFormPropertySerializable prop,
                             CS2REACTJS.Model.Serializable.ModelViewSerializable model,
                             CS2REACTJS.Model.Serializable.DbContextSerializable context)
        {
            bool result = false;
        ...
        List<ModelViewPropertyOfVwSerializable> GetAllForeignKeyProps(CS2REACTJS.Model.Serializable.ModelViewSerializable model)
        {
            List<ModelViewPropertyOfVwSerializable> result = new List<ModelViewPropertyOfVwSerializable>();
            if (model == null)
            {
        ...
        ModelViewPropertyOfVwSerializable GetOnValChangeViewPropName(CS2REACTJS.Model.Serializable.DbContextSerializable context, CS2REACTJS.Model.Serializable.ModelViewSerializable model,
        ...
        bool HasOnValChangedMethod(CS2REACTJS.Model.Serializable.DbContextSerializable context, CS2REACTJS.Model.Serializable.ModelViewSerializable model,
