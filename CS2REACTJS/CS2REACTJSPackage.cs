...
namespace CS2REACTJS
{
    ...
    [Guid(CS2REACTJSPackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class CS2REACTJSPackage : AsyncPackage
    {
        /// <summary>
        /// CS2REACTJSPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "e6eb35d1-0913-4ba7-b8b6-db0573bd5a8e";
